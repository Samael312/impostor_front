    ...
    <Layout>
      <div className="flex flex-col items-center space-y-5 py-2">
        ...
        <motion.div animate={{ y: [0, -5, 0] }} transition={{ duration: 3, repeat: Infinity }} className="text-center">
          <h1 className="text-4xl mr-serif font-black text-transparent bg-clip-text bg-gradient-to-br from-emerald-400 via-teal-300 to-cyan-500 drop-shadow-[0_0_15px_rgba(52,211,153,0.4)]">
            IMPOSTOR
          </h1>
        </motion.div>
